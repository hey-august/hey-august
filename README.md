...
|[Colima](https://github.com/abiosoft/colima)|A great drop-in container runtime for macOS|Awesome (scriptable) CLI.|
...
|[GitUI](https://github.com/extrawurst/gitui)|A powerful TUI for Git. |Bring a fast and flexible git UI (including visual diffs) to your terminal of choice.|
